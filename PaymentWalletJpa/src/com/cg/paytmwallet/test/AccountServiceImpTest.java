...
public class AccountServiceImpTest {
	...
	public void testCreateAccountName() {
		...
		acc.setemail("himanshu@gmail.com");
	...
	public void testCreateAccount() {
		...
		acc.setemail("abhishek@gmail.com");
	...
	public void testPrintTransactionMobileNo()  {
		try {
			accService.printTransactionDetails("98765432");
		} catch (AccountException e) {
			assertEquals("Mobile Number should contain 10 digits",e.getMessage());
		}
	}
	...
	public void testprintTransactionDetails()  {
		AccountApp1 acc=new AccountApp1();
		try {
			AccountApp1 acc1 = accService.printTransactionDetails("9999999999");
			assertNotNull(acc1);
		} catch (AccountException e) {
			System.out.println(e.getMessage());
